    ...
    def update_gui(self):
        ...
        while not done:
            ...
            try:
                ...
                self.draw_line([1, 1], [14, 1])
                self.draw_line([3, 3], [12, 3])
                self.draw_line([5, 5], [10, 5])
                # Lower horizontal lines
                self.draw_line([5, 10], [10, 10])
                self.draw_line([3, 12], [12, 12])
                self.draw_line([1, 14], [14, 14])
                # Middle horizontal lines
                self.draw_line([1, 7.5], [5, 7.5])
                self.draw_line([10, 7.5], [14, 7.5])
