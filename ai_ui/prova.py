...
LINES = (10, 10, 10) # white
franc = pygame.image.load(r'/home/martino/hackathon/morrisclone/NineMensMorrisBoard/UI/ai/franc.png')
euro = pygame.image.load(r'/home/martino/hackathon/morrisclone/NineMensMorrisBoard/UI/ai/cent.png')
franc= pygame.transform.scale(franc,(60,60))
grid = pygame.image.load(r'/home/martino/hackathon/morrisclone/NineMensMorrisBoard/UI/ai/grid.png')
...
class GameState:
    ...
    def draw_line(self, start, end):
        pygame.draw.line(self.screen, LINES, [x*SCALE for x in start], [x*SCALE for x in end], 5)
        pygame.draw.line(self.screen, LINES, [x*SCALE for x in start[::-1]], [x*SCALE for x in end[::-1]], 5)
